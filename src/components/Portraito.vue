<template>
	<div class="ly">
			...
			<div v-show="isShow" class="bl_pop">
				...
				<div>
					<div class="r">
						...
						<p>{{Location}}</p>
						<h5>その他の写真</h5>
						<button @click="cha_l()">他の写真をみる</button>
						<p><img class="el_popImg_l" :src="popphoto_l" type="button" @click="cha_l()"></p>
						<p><img class="el_popImg_r" :src="popphoto_r" type="button" @click="cha_r()"></p>
					</div>
				</div>
			</div>
		</div>
		<div class="bl">
			<div class="bl_img">
				<span class="bl_img_ttl">Work</span>
			...
			<div class="bl_img">
				<span class="bl_img_ttl">Happy</span>
			...
			<div class="bl_img">
				<span class="bl_img_ttl">Girl</span>
			...
			<div class="bl_img">
				<span class="bl_img_ttl">Boy</span>
